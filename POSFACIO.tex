...
\noindent{}\textls[-15]{\textit{Em busca de meus irmãos na América}, de Chaim
...
\textls[-15]{Como Chaim mostra em diversas passagens, o trabalho de mascate, e depois no comércio e
...
\textls[10]{Depois de diversas iniciativas, Chaim empreende diversos negócios, entre
...
\textls[15]{No Recife, já casado, ao estabilizar-se economicamente, ``Tornei-me uma pessoa importante, proprietário, e podia mandar os meus filhos para estudarem em uma escola judaica'', escreveu ele. Por entender
...
\textls[-18]{As memórias de Chaim perpassam ainda temas importantes da história da
