...
\textit{\textls[10]{Meu nome é Chaim Novodvorsky. Nasci em Knishin, uma pequena cidade da
...
\textls[10]{Fui então até uma companhia marítima, onde me informaram que seria possível
...
\textls[-17]{Voltei para casa e contei tudo ao meu pai. Resolvemos que eu
...
\textls[-5]{Tinha trazido comigo o endereço de uma senhora cujos pais eram nossos
...
\textls[-15]{Dirigi-me ao endereço indicado no anúncio e me apresentei como padeiro.
 ...
 anoitecer para fazer o teste. Era sexta-feira.}\looseness=-1

\textls[-20]{Quando cheguei lá, me perguntou se eu sabia sovar a massa. Respondi que na minha cidade não
...
que rissem de mim.}\looseness=-1

\textls[-10]{Trabalhei a noite inteira, dormi um pouco e de madrugada ele me acordou
...
\textls[-5]{Continuei trabalhando na padaria, com direito a
...
\textls[-23]{Na Corrientes, encontrei meus \textit{irmãos de navio} e contei o 
...
\textls[-19]{Acordava bem cedo, e os donos da pensão nunca ficaram sabendo que estava
...
centavos. Quem não podia não pagava nada, comia de graça.}\looseness=-1
...
\textls[-13]{Na sexta-feira à noite, apareceu um senhor que se aproximou da mesa onde
...
\textls[-15]{Eles me fizeram muitas perguntas. Contei que vim trabalhar para ganhar dinheiro e poder me reunir com meus irmãos, pois 
...
brincos, anéis, livros, discos e objetos de uso pessoal.}\looseness=-1
...
\textls[10]{Depois de alguns meses, como não recebi o aumento, resolvi procurar
...
\textls[10]{O mestre de obras disse: ``Aqui estamos só nós dois e o dono não vai
...
\textls[10]{Dirigiram-se ao curso de arte dramática, e pediram aos alunos que 
...
\textls[-15]{Chegaram então atores e atrizes da América do Norte, e
...
muitas outras peças.}\looseness=-1\footnote{Em sequência, as traduções dos títulos das peças são: \textit{A transmutação}, \textit{Trinta e três anos de colonização}, \textit{Entre o dia e a noite}, \textit{O Conde Patotzki}, \textit{É difícil ser um judeu} e \textit{O casamento romeno}.}
...
\textls[-5]{Fiquei com pouco dinheiro. Disseram que poderia viajar
...
\textls[-20]{Fui até lá. Contei que acabara de chegar de navio da Argentina, mostrei
...
perguntei como conseguiria algum trabalho.}\looseness=-1
...
\textls[3]{Já estava dormindo quando algo começou a me picar, a morder, acho que o
...
\textls[10]{Após tomar um bom banho, fui até a Praça Onze me encontrar com os judeus
...
\textls[-10]{Fui até o consulado da Polônia, levando a carteira de identidade
...
\textls[-20]{Tomei um navio e cheguei até o Recife. Durante dois dias, o navio permaneceu no porto para descarregar. Desci e fui levar um pacote para os 
...
\textls[7]{Ele me perguntou se tinha um pouco de dinheiro. Afirmei que sim,
...
\textls[5]{Fui para a delegacia. O delegado leu para mim o que o meu sócio
...
\textls[10]{Ele me ouviu com atenção e disse que, se quisesse, teria um serviço para
mim.}
...
\textls[10]{Trabalhava com o realejo em toda parte, e me sustentei tirando a sorte. Permanecia 
...
\textls[-18]{Quando o marido dela chegou do trabalho --- ele era \textit{klienteltchik} ---,}\looseness=-1\footnote{Em tradução, \textit{mascate}.} 
\textls[-18]{fiquei conversando com o casal, jantei com eles e
...
\textls[10]{No dia seguinte, fui levado bem cedo ao hospital, e o médico me
...
\textls[7]{No dia seguinte, quando cheguei, me disseram que 
...
\textls[10]{Entendi aos poucos que o assunto dizia respeito a mim. O jovem com quem conversei
...
\textls[-15]{Eu comprava as mercadorias e entregava a domicílio. Minha esposa,
...
\textls[-10]{Eu e minha esposa, cujo nome é Marta (Machlia, nos documentos), continuamos
...
\textls[-15]{Aconteceu que o meu sócio não era honesto comigo. Como era ele o
...
\textls[-15]{Trabalhei com ele desse jeito por seis meses,
...
\textls[-5]{Trabalhei para a escola durante
...
Burstein, Alpern, Oksman e Bekin.}\looseness=-1
...
\textls[-5]{Comemoramos com muita alegria o primeiro
...
percebi que não era exatamente como o amigo tinha escrito. Esse amigo era solteiro, e para ele era realmente suficiente o que ganhava. Mas meu genro precisava ganhar mais, tinha uma família para sustentar.\looseness=-1
...
estudando e não podiam perder o ano letivo.\looseness=-1
...
bem sem ser enganado. Comecei então a vender relógios e joias. Depois, completei as prateleiras com rádios e outros aparelhos úteis para uma casa.\looseness=-1
